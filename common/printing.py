...
def print_magenta(s: str) -> None:
    """Prints s in magenta"""
    print("{}{}{}".format(CVIOLET2, s, CEND))


def print_purple(s: str) -> None:
    """Prints s in purple"""
...
def print_light_gray(s: str) -> None:
...
def print_intro(team: str, hw: str, code: str) -> None:
    print_double()
    print(
...
def print_between_cyan_line(msg: str) -> None:
    print_line()
    print_cyan(msg)
    print_line()


def print_outro(table_item: Any) -> None:
    print_line()
